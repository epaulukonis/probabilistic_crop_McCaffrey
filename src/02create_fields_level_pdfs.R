    ...
    file.exists(stanislaus_filename))
{
  ...
  print(county)
  probs_by_fields<-readRDS(file = sacramento_filename)  #data frame of field probs by county ## change here!
  ...
  print('specify county here')
  print(county)
  probs_by_fields<-readRDS(file = sacramento_filename) #use extracted finished dataframe ## specify county here too
  print("loading extracted field file for county of interest here")
  print(Sys.time())

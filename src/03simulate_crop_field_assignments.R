    ...
    file.exists(field_areas_filename))
{
  ...
  # #note that you will specify which county in 02, and also here
 ...
 # saveRDS(simulation_matrix, file = file.path(root_data_out, "simulation_matrix_stan"))
  simulation_matrix_filename <- file.path(root_data_out, "simulation_matrix_mer.rds")
 ...
 # saveRDS(crop_probs, file = file.path(root_data_out, "crop_probs_stan"))
  crop_probs_filename <- file.path(root_data_out, "crop_probs.rds")
  ...
  total_crop_and_field_area_filename <- file.path(root_data_out, "total_crop_and_field_area.rds")
  ...
  field_areas_filename <- file.path(root_data_out, "field_areas.rds")
...
write.csv(crop_probs, file = file.path(root_data_out, "crop_probs.csv"))

print("saving independent field areas by sim object")
print(Sys.time())
saveRDS(total_crop_and_field_area, file = file.path(root_data_out, "total_crop_and_field_area"))
write.csv(total_crop_and_field_area, file = file.path(root_data_out, "total_crop_and_field_area.csv"))

print("saving area_by_field object")
print(Sys.time())
saveRDS(field_areas, file = file.path(root_data_out, "field_areas"))
write.csv(field_areas, file = file.path(root_data_out, "field_areas.csv"))

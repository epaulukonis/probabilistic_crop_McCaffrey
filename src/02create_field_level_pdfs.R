...
print("stepping into 02create_field_level_pdfs.R")
print(Sys.time())
...
probs_by_field_filename <- file.path(root_data_out, "probs_by_fields.rds")
...
if(file.exists(extract_to_fields_filename) && 
   file.exists(probs_by_field_filename)&& 
  ...
  print("saving probs_by_field object")
  print(Sys.time())
...
print("finished field extraction")
